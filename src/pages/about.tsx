...
const SectionHeading = ({ title, subtitle, light = false }: { title: string; subtitle?: string, light?: boolean }) => (
  <div className="mb-20 text-center md:text-left">
    {subtitle && (
      <p className={`text-[10px] uppercase tracking-[0.4em] mb-6 font-bold flex items-center justify-center md:justify-start gap-4 ${light ? 'text-neutral-400' : 'text-neutral-500'}`}>
        <span className={`w-8 h-[1px] block ${light ? 'bg-neutral-600' : 'bg-neutral-300'}`} />
        {subtitle}
      </p>
    )}
    <h2 className={`text-5xl md:text-7xl leading-none uppercase tracking-tight ${light ? 'text-white' : 'text-primary'}`}>{title}</h2>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
          ...
          <motion.div 
            ...
            className="md:col-span-2 relative p-12 flex flex-col justify-end overflow-hidden group rounded-sm bg-primary"
          >
          ...
          <motion.div 
            ...
            className="p-12 bg-white flex flex-col justify-center rounded-sm shadow-xl border border-neutral-100 relative overflow-hidden group"
          >
            <div className="absolute -right-10 -top-10 w-40 h-40 bg-secondary rounded-full blur-3xl group-hover:bg-neutral-200 transition-colors duration-500 z-0" />
            <div className="relative z-10">
              <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-neutral-400 mb-4 block">01</span>
              <h3 className="text-3xl mb-6 font-display tracking-wide text-primary">Our Vision</h3>
          ...
          <motion.div 
            ...
            className="p-12 bg-white flex flex-col justify-center rounded-sm shadow-xl border border-neutral-100 relative overflow-hidden group"
          >
             <div className="absolute -left-10 -bottom-10 w-40 h-40 bg-neutral-100 rounded-full blur-3xl group-hover:bg-neutral-200 transition-colors duration-500 z-0" />
            <div className="relative z-10">
              <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-neutral-400 mb-4 block">02</span>
              <h3 className="text-3xl mb-6 font-display tracking-wide text-primary">Our Mission</h3>
              <p className="text-neutral-500 leading-relaxed text-sm">
          ...
          >
             <img 
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-black/40 backdrop-blur-sm">
                <p className="text-white font-display text-4xl tracking-widest">Mastery in Detail</p>
              </div>
          </motion.div>
        </div>
      </div>
